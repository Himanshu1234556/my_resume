...
\section{\textcolor{headingColor}{\textbf{Trainings/Internships}}}
\vspace{-0.4mm}
\resumeSubHeadingListStart
\resumePOR{765/400 KV Substation } % Award
    {Mainpuri UttarPradesh \textbf{(28 Days Summer Internship)} } % Event
