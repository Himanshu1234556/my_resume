...
\section{\textcolor{headingColor}{\textbf{Entrepreneurial Experience}}}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
    \item {\textbf{Product Development}: Conceived and launched "Mentor Series," a cutting-edge smart exam guide platform featuring QR codes for instant access to video solutions.}
    ...
    \item {\textbf{Technology Developement}: Developed a mobile app and website for book access and online delivery, achieving 1000+ app downloads.}
   ...
   \item {\textbf{Sales and Marketing:}: Conducted webinars and social media marketing campaigns, resulting in the sale of 1500+ books.}
    \resumeItemListEnd
...
\resumeSubHeadingListStart
    ...
    %  {\href{https://what-to-watch-next.herokuapp.com/}{Live Url} 
     ...
     \resumeItemListStart
       ...
       \item {\textbf{Tools \& technologies used}: Aurdino, Relay, PHP, Html, CSS, Js}
    \resumeItemListEnd
    ...
    \resumeProject
     ...
     % {\href{https://github.com/ankit0696/kisan_mitra}%%{Github}} %Website
      ...
      \resumeItemListStart
         \item {\textbf{Tools \& technologies used}: Aurdino, BC547 Transistor, LDR, Resistances, Relay, Diode}
    \resumeItemListEnd
    ...
    %  {\href{https://what-to-watch-next.herokuapp.com/}{Live Url} 
     ...
     \resumeItemListStart
       ...
       \item {\textbf{Tools \& technologies used}:  Relay, Diode, Battery, BC547, 555 Timer IC, Registers}
    \resumeItemListEnd 
...
\section{\textcolor{headingColor}{\textbf{Skills}}}
 ...
 \resumeSubItem{Tools \& OS: } % Category
    {Aurdino, Raspberry Pi, Motors, Transformers, Git, Linux, Windows } % Skills
